========================================================================
    WIN32-ANWENDUNG: n-Body_Problem_2D-Projektübersicht
========================================================================

Diese n-Body_Problem_2D-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre n-Body_Problem_2D-Anwendung besteht.


n-Body_Problem_2D.vcxproj
...
n-Body_Problem_2D.vcxproj.filters
...
n-Body_Problem_2D.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol (32x32) verwendet wird. Dieses Symbol ist in der Hauptressourcendatei "n-Body_Problem_2D.rc"     enthalten.

small.ico
    Dies ist eine Symboldatei, die eine kleinere Version (16x16) des Anwendungssymbols enthält. Dieses Symbol ist in der Hauptressourcendatei "n-Body_Problem_2D.rc"     enthalten.

/////////////////////////////////////////////////////////////////////////////
Andere Standarddateien:

StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen n-Body_Problem_2D.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
